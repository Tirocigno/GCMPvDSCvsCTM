...
\title[Trajectory Clustering Comparison]{Trajectory Clustering Alghorithms - GCPM vs DSC vs CTM. } % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{frame}
	...
	\begin{columns}
		...
		Lorem ipso dolorem, queri niesce ed faciam
